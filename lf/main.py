...
if __name__ == '__main__':
    ...
    if result is not None:
        ...
        update_rows_into_processed_data(db_connector, result, DATASOURCE)  # обновляем БД
        print(select_all_from_source_files(db_connector))  # вывод списка всех обработанных файлов
        # insert_rows_into_processed_data(db_connector, result.iloc[:100], DATASOURCE)  # записываем в БД 100 первых строк результата
